...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-azure/15 bg-ink/95 text-white backdrop-blur-md">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 px-4 py-3.5">
        ...
        >
          <span
            className="inline-block h-2.5 w-2.5 rounded-full bg-gradient-to-br from-azure-bright to-coral shadow-[0_0_0_3px_rgba(59,130,246,0.35)]"
            aria-hidden
          />
